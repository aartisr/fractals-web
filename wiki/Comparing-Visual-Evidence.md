...
1. State what differs between the two images or methods.
2. Compare the same kind of region or condition in each image.
3. Inspect the complexity estimates and their quality context.
4. Describe the evidence without claiming more than the measurement supports.
