...
1. Choose the image and a meaningful region of interest.
2. Inspect the box-count relationship across scales.
3. Check the displayed fit-quality context before interpreting an estimate.
4. Save the run and its parameters if the result will be discussed or compared.
